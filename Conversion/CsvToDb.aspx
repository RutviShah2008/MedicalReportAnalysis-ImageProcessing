<%@ Page Title="" Language="C#" MasterPageFile="~/Conversion/MasterPage.master" AutoEventWireup="true" CodeFile="CsvToDb.aspx.cs" Inherits="Default2" %>
    ...
    <table>
        ...
        <tr>
            ...
            <td class="auto-style7">
                <asp:TextBox ID="txtPatientName" runat="server" Font-Size="Large" Enabled="False"></asp:TextBox>
            </td>
            <td class="auto-style2">
                &nbsp;</td>
        </tr>
    ...
    <asp:Button ID="Button1" runat="server" OnClick="Button1_Click" Text="Convert" />
        ...
        <tr>
            <td class="auto-style1">
                ...
                <asp:HyperLink ID="HyperLink3" runat="server" Font-Size="Large" ForeColor="#000099" NavigateUrl="~/Patient/ReportFilterData - Copy.aspx">View Report</asp:HyperLink>
            </td>
            <td>
                &nbsp;</td>
            <td class="auto-style2">
