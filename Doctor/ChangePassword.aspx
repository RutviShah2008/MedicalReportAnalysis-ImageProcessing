<%@ Page Title="" Language="C#" MasterPageFile="~/Doctor/Link.master" AutoEventWireup="true" CodeFile="ChangePassword.aspx.cs" Inherits="ChangePassword" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <table class="auto-style1">
        ...
        <tr>
            <td>
                <asp:Label ID="Label5" runat="server" Text="Change Password" ForeColor="Black" Font-Size="Medium"></asp:Label>
            </td>
            <td>
        ...
        <tr>
            ...
            <td class="auto-style2">
                <asp:Label ID="Label6" runat="server" Text="Label" ForeColor="Black" Font-Size="Medium"></asp:Label>
            </td>
            <td class="auto-style2"></td>
        </tr>
        <tr>
